...
class CustomCard extends StatelessWidget {
  ...
  const CustomCard({super.key, required this.game});
                          ...
                          children: [
                            Row(
                              ...
                              children: [
                                Expanded(
                                  child: Text(
                                    game.name,
                                    style: AppStyles.ssemibold(color: AppStyles.black500),
                                ...
                                IconButton(
                                  ...
                                  onPressed: () {
                                    context.read<FavoriteCubit>().toggleFavorite(game);
                                  },
                                ),
                              ],
                            ),
                            if (game.released != null)
                              Text(
                                ...
                                style: AppStyles.xsregular(color: AppStyles.black500),
                              ),
